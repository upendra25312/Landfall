...
(`run_engagement` bulk-ingest + hard engagement scoping); **C20** core done in code
(Start analysis + data-quality summary; E11.25 questionnaire → C20b); C21–C23 + C27–C28 planned) ·
