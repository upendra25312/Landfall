...
**Epic E13: 7/17 done. Next: E13.5 (agent-run ceiling) / E13.6 (split `app.py`) / E13.9 (E12 tail) / E13.12 (learning-path doc).**) ·
**Raised:** 2026-09-08 · **Last updated:** 2026-09-10 (C50 — `ca-calc` → ACA Job) · **Owner panel:** see below · **Method:** PDCA
