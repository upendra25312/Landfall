...
| E10.4 | `evidence/{pentest,trials,chaos}/` reports | P0/P1 | in-progress | Security + SRE + Writer | 36 | Pen test passes; usability + comprehension trials meet bars; chaos drill logged. _`evidence/trials/` kit built (C36): `protocol.md` (both trials), `comprehension-answer-key.md` (3 tasks + key + scoring), `results-template.md`, `dry-run-2026-09-09.md` (apparatus validated). Comprehension trial ready; usability trial ready (needs 3 estates + architect reviewer). **Still:** run the 2 human trials; `pentest/` + `chaos/` not started._ |
