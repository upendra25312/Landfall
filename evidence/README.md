...
**Start here: [`SCORECARD.md`](SCORECARD.md)** — the nine-dimension rubric, the
current score (regenerated + CI-gated), and a link to every artefact below.
`python evidence/scorecard.py` rebuilds it.
...
| [`evals/`](evals/) | E10.3 | Pointer to the live eval scorecard ([`../evals/SCORECARD.md`](../evals/SCORECARD.md)) + dated snapshots under [`evals/history/`](evals/history/). |
| [`SCORECARD.md`](SCORECARD.md) | E10.6 | The rubric — 9 dimensions, current score (3.67/5), evidence links, residual risk. `tests/test_scorecard.py` gates it. |

Planned: `pentest/` (E8), `trials/` (Usability + Understandability), `chaos/`
(Operability), `data-handling-statement.md` (E8.7).
